...
const themeIcon = computed(() =>
  isRu.value ? "mdi-white-balance-sunny" : "mdi-moon-waning-crescent"
);
const themeTitle = computed(() =>
  isRu.value ? "Светлая тема" : "Тёмная тема"
);
const langIcon = computed(() =>
  isRu.value ? "mdi-alphabet-latin" : "mdi-alphabet-cyrillic"
);
const langTitle = computed(() =>
  isRu.value ? "Switch to English" : "Переключить на русский"
);
